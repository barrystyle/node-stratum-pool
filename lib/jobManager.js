...
var JobManager = module.exports = function JobManager(options) {
    ...
    this.processShare = function (jobId, previousDifficulty, difficulty, extraNonce1, extraNonce2, nTime, nonce, ipAddress, port, workerName, versionMask) {
        ...
        var combinedVersionInt = parseInt(job.rpcData.version, 16) + parseInt(versionMask, 16);
        var combinedVersionHex = combinedVersionInt.toString('hex');

        var headerBuffer = job.serializeHeader(merkleRoot, nTime, nonce, combinedVersionHex);
